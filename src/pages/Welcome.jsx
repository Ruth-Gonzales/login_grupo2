      ...
      <div className="relative z-10 max-w-6xl w-full grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <p className="text-slate-300 text-lg leading-relaxed mb-8 max-w-xl">
            Gestiona estudiantes, matrículas y procesos académicos desde una plataforma moderna, elegante y segura para instituciones educativas.
          </p>

          <button
            onClick={() => onNavigate("login")}
            className="px-8 py-4 rounded-2xl bg-gradient-to-r from-blue-500 to-violet-600 text-white font-semibold text-lg shadow-2xl hover:scale-105 transition duration-300 cursor-pointer"
          >
            Ingresar al Sistema
          </button>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-xl border border-white/10 rounded-[32px] p-8 shadow-2xl">
          <div className="space-y-6">
            <div className="bg-slate-900/60 rounded-2xl p-6 border border-white/5">
              <h3 className="text-white text-xl font-semibold mb-2">Matrícula Segura</h3>
              <p className="text-slate-400">Protección de datos académicos y acceso seguro.</p>
            </div>

            <div className="bg-slate-900/60 rounded-2xl p-6 border border-white/5">
              <h3 className="text-white text-xl font-semibold mb-2">Gestión Inteligente</h3>
              <p className="text-slate-400">Organización eficiente de estudiantes y carreras.</p>
            </div>

            <div className="bg-slate-900/60 rounded-2xl p-6 border border-white/5">
              <h3 className="text-white text-xl font-semibold mb-2">Experiencia Moderna</h3>
              <p className="text-slate-400">Diseño premium adaptable para móviles y escritorio.</p>
            </div>
          </div>
        </div>
      </div>
