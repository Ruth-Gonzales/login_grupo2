    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#0f172a] via-[#1e1b4b] to-[#0f172a] relative overflow-hidden font-sans">
      ...
      <div className="relative bg-white/10 backdrop-blur-xl border border-white/20 p-10 rounded-3xl shadow-[0_8px_32px_0_rgba(0,0,0,0.36)] w-full max-w-md z-10 text-white">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Botón separador o texto */}
          <div className="relative my-4">
            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-t border-white/20"></div>
            </div>
            <div className="relative flex justify-center text-xs">
              <span className="px-2 bg-transparent text-gray-400">O</span>
            </div>
          </div>

          {/* Botón para acceder directamente a Matrícula */}
          <button
            type="button"
            onClick={onLogin}
            className="w-full bg-white/10 border border-white/20 text-white font-bold py-3 rounded-xl hover:bg-white/20 transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]"
          >
            Acceder a Matrícula (Demo)
          </button>
        </form>
      </div>
    </div>
